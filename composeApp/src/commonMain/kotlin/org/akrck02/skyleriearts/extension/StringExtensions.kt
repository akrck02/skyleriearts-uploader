...
/**
 * @author https://github.com/aallam
 ...
 */
fun CharSequence.damerauLevenshteinDistance(second: CharSequence): Int {
    ...
    for (index in this.indices) charsRowIndex[this[index]] = 0
